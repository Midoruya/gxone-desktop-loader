	...
	<div class="loading-block">
		<div class="loading-block-content">
			<svg class="loading-block-content-spinner" viewBox="0 0 50 50">
				<circle class="loading-block-content-spinner-path" cx="25" cy="25" r="20" fill="none" stroke-width="2"></circle>
			</svg>
			<h1>PHANTOM</h1>
			<a>{{ loading_status }}</a>
		</div>
...
export default {
	...
	mounted() {
		...
		window.require('electron').ipcRenderer.on('loading-block-sender', (event, arg) => {
