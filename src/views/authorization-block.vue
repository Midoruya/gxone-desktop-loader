	...
	<div class="authorization-block">
		<div class="authorization-block-container">
			<div class="authorization-block-container-block">
				<img src="https://media.discordapp.net/attachments/801514450535972865/973627930079010846/unknown.png" alt="" />
				<h1>PHANTOM</h1>
				<CustomInput v-model:input="username" style="margin: 38px 0 10px 0" height="32" width="300" placeholder="Login" inpyt_type="text">
					<template v-slot:icon>
						<svg style="margin: 0 12px 0 14px" width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
				...
				<CustomInput v-model:input="password" height="32" width="300" placeholder="Password" inpyt_type="password">
					<template v-slot:icon>
						<svg style="margin: 0 11px 0 13px" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="8.5" cy="6.5" r="5.1" stroke="#D6D6D6" stroke-width="1.2" />
							<rect x="0.6" y="6.6" width="15.8" height="9.8" rx="2.4" fill="#1B1E25" stroke="#D6D6D6" stroke-width="1.2" />
						</svg>
					</template>
				</CustomInput>
				<CustomCheckbox style="margin: 20px 0 32px 0; width: 290px" @select="save_credits" name="Save credits" :value="save_profile" />
				<CustomButtonFirst @click="sing_in_from_account()" height="32" name="Авторизация" width="240" />
				<h5>
					Doesn’t have
